...
class RemoveV2ContentTestCase(unittest.TestCase):
    ...
    * `Pulp #5181 <https://pulp.plan.io/issues/5181>`_.
    ...
    def test_07_remove_manifest_list_not_shared(self):
        ...
        single_non_shared_manifest_list = []
        single_non_shared_manifest_list.append(NON_SHARED_MANIFEST_LIST[0])
        self.delete_docker_units(repo, single_non_shared_manifest_list)
    ...
    def test_08_remove_manifest_list_shared(self):
        ...
        # Delete by SHA256 in batch of 1 SHA256
        single_shared_manifest_list = []
        single_shared_manifest_list.append(SHARED_MANIFEST_LIST[0])
        self.delete_docker_units(repo, single_shared_manifest_list)
    ...
    def test_09_remove_manifest_not_shared(self):
        ...
        # Delete by SHA256 in batch of 1 SHA256
        single_not_shared_manifest = []
        single_not_shared_manifest.append(NON_SHARED_MANIFEST[0])
        self.delete_docker_units(repo, single_not_shared_manifest)
    ...
    def test_10_remove_manifest_shared(self):
        ...
        # Delete by SHA256 in batch of 1 SHA256
        single_shared_manifest = []
        single_shared_manifest.append(SHARED_MANIFEST[0])
        self.delete_docker_units(repo, single_shared_manifest)
